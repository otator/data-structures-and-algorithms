...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort((a,b)=>{
    if(sortedDays.indexOf(a.dayOfWeek) < sortedDays.indexOf(b.dayOfWeek))
      return -1;
    else if(sortedDays.indexOf(a.dayOfWeek) > sortedDays.indexOf(b.dayOfWeek))
      return 1;
    else
      return 0;
  });
...
//there is a bug in this code, please if someone sees this note, let me know what is the solution for this challenge.
const sortSchedule = (arr) => {
  ...
  let endA, endB;
  arr.sort((a,b)=>{
    startA = Number(a.start);
    startB = Number(b.start);
    if(startA < startB)
      return -1;
